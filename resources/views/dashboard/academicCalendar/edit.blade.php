...
@section('title', 'Edit Academic Calendar')
@section('dashboard')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Now editing {{ $academic->name }}</h4>
                        <form method="POST" action="{{ route('academics.update', $academic) }}">
                            @csrf
                            @method('PUT')
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group {{($errors->has('name')) ? 'has-error' : ''}}">
                                            ...
                                            <input autofocus="true" name="name" class="form-control" id="name" type="text"
                                                   placeholder="enter academic calendar name" value="{{ old('name', $academic->name) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group {{($errors->has('resumption')) ? 'has-error' : ''}}">
                                            ...
                                            <input name="resumption" class="form-control" id="resumption" type="date"
                                                   placeholder="enter school resumption date" value="{{ old('resumption', $academic->resumption) }}">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group {{($errors->has('vacation')) ? 'has-error' : ''}}">
                                            ...
                                            <input name="vacation" class="form-control" id="vacation" type="date"
                                                   placeholder="enter school vacation date" value="{{ old('vacation', $academic->vacation) }}">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group {{($errors->has('session_id')) ? 'has-error' : ''}}">
                                            ...
                                            <select name="session_id" class="form-control" id="session_id" type="text">
                                                ...
                                                @forelse($sessions as $session)
                                                    <option
                                                        {{ old('session_id', $academic->session_id) == $session->id ? "selected" : "" }} value="{{ $session->id }}">{{ $session->name }}</option>
                                                @empty
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group {{($errors->has('body')) ? 'has-error' : ''}}">
                                            ...
                                            <textarea cols="5" rows="5" name="body" class="form-control" id="body" type="text"
                                                      placeholder="enter academic calendar body">{{ old('body', $academic->body) }}</textarea>
                                        </div>
                                    </div>
                                </div>
