        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#save_signature', function(event) {
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                        // $('.preloader').show();
                        toastr.info('Hang-on', 'Request is being processed.')
                    },
                    // return the result
                    success: function(r) {
                        // Display a success toast, with a title
                        signaturePad.clear();
                        toastr.success('Success', 'Signature saved Successfully.')
                    },
                    complete: function() {
                        //$('.preloader').hide();
                        //toastr.clear()
