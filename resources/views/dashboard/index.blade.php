                    ...
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                                    class="set-doller"></sup>{{ $teacher }}</h2>
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Number of Teachers
                            </h6>
                        </div>
                        <div class="ml-auto mt-md-3 mt-lg-0">
                            @canany(['principal', 'vice_principal_academy', 'vice_principal_admin', 'admin'])
            ...
            <div class="card border-right">
                <div class="card-body">
                    <div class="d-flex d-lg-flex d-md-block align-items-center">
                        <div>
                            <div class="d-inline-flex align-items-center">
                                <h2 class="text-dark mb-1 font-weight-medium">{{ $class . ' / '. $section }}</h2>
{{--                                <span--}}
