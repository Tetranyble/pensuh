                            ...
                            <div class="row">
                                <div class="col-md-8 col-sm-6">
                                    <table class=" table-bordered">
                                        <thead>
                                        <tr>
                                            <th class="pr-2 pl-2"><small><b>Courses</b>

                                                </small></th>
                                            <th class="pr-2 pl-2"><small>Resumption Test</small></th>
                                            <th class="pr-2 pl-2"><small>Notes</small></th>
                                            <th class="pr-2 pl-2"><small>Project</small></th>
                                            <th class="pr-2 pl-2"><small>Class Work</small></th>
                                            <th class="pr-2 pl-2"><small>Assignment</small></th>
                                            <th class="pr-2 pl-2"><small>Mid Term Test</small></th>
                                            <th class="pr-2 pl-2"><small>Attendance</small></th>
                                            <th class="pr-2 pl-2"><small>Examination</small></th>
                                            <th class="pr-2 pl-2"><small>Position</small></th>
                                            <th class="pr-2 pl-2"><small>Class Average</small></th>
                                            <th class="pr-2 pl-2"><small>Grade</small></th>
                                            <th class="pr-2 pl-2"><small>Remark</small></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                ...
                                <div class="col-md-2 col-sm-3">
                                    <table class=" table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td class="pr-2 pl-2"><small>{{ $report->handwriting }}</small></td>
                                            <td class="pr-2 pl-2"><small>{{ $report->user->fullname }}</small></td>
                                        </tr>
                                        <tr>
...
// Private methods
        ...
        console.log( $('#sportman').data('sportman'), 'hello world')
        var formteacher = new SignaturePad(document.querySelector("#formTeacher"));
        formteacher.off()
            var form = $('#formteacher').data('formteacher');
            formteacher.fromData(form)

        var sport = new SignaturePad(document.querySelector("#sportMan"));
            sport.off()
        var sp = $('#sportman').data('sportman');

        sport.fromData(sp)

        var counsellor = new SignaturePad(document.querySelector("#Counsellor"));
        counsellor.off()
        var counsel = $('#counsellor').data('counsellor');
        counsellor.fromData(counsel)

        var principal = new SignaturePad(document.querySelector("#Principal"));
        principal.off()
        var principle = $('#principal').data('principal');
        principal.fromData(principle)
        ...
        $(function() {
            $('#download').on('click', function (e) {
                var opt = {
                    margin: 0,
                    filename: '{{\Illuminate\Support\Str::slug($report->student->fullname)}}.pdf',
